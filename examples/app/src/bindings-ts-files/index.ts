...
export const commands = {
	...
	richTypes: (arg: tauri_specta_example_app.RichTypes) => __TAURI_INVOKE<tauri_specta_example_app.RichTypes>("rich_types", { arg: ({...arg,bytes:[...arg.bytes]}) }).then((v) => (({...v,date:new Date(v.date),bytes:new Uint8Array(v.bytes),url:new URL(v.url)}) as typeof v)),
};
