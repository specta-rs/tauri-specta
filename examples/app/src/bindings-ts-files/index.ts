...
import type * as tauri_specta_example_app$nested from "./tauri_specta_example_app/nested";
...
export const commands = {
	...
	someStruct: () => __TAURI_INVOKE<tauri_specta_example_app$nested.MyStruct>("some_struct"),
	...
	typesafeErrorsUsingThiserror: () => typedError<null, tauri_specta_example_app.MyError_Serialize>(__TAURI_INVOKE("typesafe_errors_using_thiserror")),
...
/** Events */
export const events = {
	emptyEvent: makeEvent<tauri_specta_example_app.EmptyEvent, tauri_specta_example_app.EmptyEvent>("empty-event"),
	myDemoEvent: makeEvent<tauri_specta_example_app.DemoEvent, tauri_specta_example_app.DemoEvent>("myDemoEvent"),
	semanticTypesEvent: makeEvent<tauri_specta_example_app.SemanticTypesEvent, tauri_specta_example_app.SemanticTypesEvent>("semantic-types-event", (v) => ({...v,bytes:[...v.bytes]}), (v) => ({...v,date:new Date(v.date),bytes:new Uint8Array(v.bytes),url:new URL(v.url)})),
};
