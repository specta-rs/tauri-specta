...
export const events = {
	...
	semanticTypesEvent: makeEvent<tauri_specta_example_app.SemanticTypesEvent>("semantic-types-event", (v) => ({...v,bytes:[...v.bytes]}), (v) => ({...v,date:new Date(v.date),bytes:new Uint8Array(v.bytes),url:new URL(v.url)})),
};
